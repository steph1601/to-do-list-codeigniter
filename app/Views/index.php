        ...
        <?php if(!empty($tasks)): ?>
                    ...
                    <div class="col">
                        <div class="card h-100 border-black">
                            <div class="card-body"> 
                                ...
                                <a class="btn btn-primary" href="/todo/edit/<?= $todo['id'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
            ...
            <?php else: ?>
                <div class="d-flex justify-content-center mt-5">
                    <span><h1 class="text-secondary">No Task Yet</h1></span>                  
                </div>
                <div class="d-flex justify-content-center">
                    <span><a  class="link-offset-2 link-underline link-underline-opacity-0 text-secondary" href="/todo/create">Click here to add a task</a></span>
                </div>
            <?php endif; ?>
